...
#Reset inputs
func reset_dir():
	if up_input and down_input and left_input and right_input == "":
		return
	elif up_input == "move_up" and down_input == "move_down" and left_input == "move_left" and right_input == "move_right":
